...
AddEventHandler("menupolice:PoliceOG", function(target, rangPolice) -- 0 rien, 1 Cadet, 2 Brigadier, 3 Sergent, 4 Lieutenant, 5 Capitaine, 6 Commandant
		...
		VMenu.AddFunc(98, "Saisir argent sale ", "menupolice:seizecash", {}, "Accéder")
		VMenu.AddFunc(98, "Saisir objets illégaux", "menupolice:seizedrug", {}, "Accéder")
		...
		VMenu.AddFunc(98, "Crocheter serrure du véhicule", "menupolice:unlock", {}, "Accéder")

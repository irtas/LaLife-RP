...
Citizen.CreateThread(function()
	while true do
		...
		if(IsPedInAnyVehicle(GetPlayerPed(-1), false))then
			...
			drawRct(0.179, 0.809, 0.005,0.173,0,0,0,100)  -- UI:engine_damage
			drawRct(0.1861, 0.809, 0.005,0.173,0,0,0,100)  -- UI:body_damage
			drawRct(0.1861, 0.809, 0.005,veh_body_health/5800,0,0,0,100)  -- UI:body_damage
			drawRct(0.179, 0.768, 0.0122, 0.038, 0,0,0,150)        -- UI: 1
			...
			elseif veh_engine_health < 1 then
				drawRct(0.179, 0.809, 0.005, 0,0,0,0,100)  -- panel damage
				...
				drawRct(0.179, 0.809, 0.005, veh_engine_health / 5800,0,0,0,100)  -- panel damage
				-- drawTxt(0.645, 1.270, 1.0,1.0,0.45, "~w~AC", 255, 255, 255, 150)
			end

			if veh_stop then
				drawTxt(0.6805, 1.262, 1.0,1.0,0.6, "~r~P", 255, 255, 255, 200)
			else
				drawTxt(0.6805, 1.262, 1.0,1.0,0.6, "P", 255, 255, 255, 150)
			end
		end
	end
end)
